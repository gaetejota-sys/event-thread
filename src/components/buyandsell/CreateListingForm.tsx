...
export const CreateListingForm = ({ onClose, onSuccess }: CreateListingFormProps) => {
  const { user } = useAuth();
  ...
  const onSubmit = async (data: ListingFormData) => {
    if (!user) {
      toast({
        title: "Error",
        description: "Debes estar logueado para crear un aviso",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "¡Aviso creado!",
        description: "Tu aviso ha sido publicado exitosamente",
      });
      ...
      toast({
        title: "Error",
        description: "No se pudo crear el aviso. Inténtalo nuevamente.",
        variant: "destructive",
      });
    } finally {
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue("type", value as any)} required>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue("comuna", value)} required>
              <SelectTrigger>
